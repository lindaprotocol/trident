...
import static org.linda.trident.core.Constant.TRANSACTION_DEFAULT_EXPIRATION_TIME;
import static org.linda.trident.core.utils.TokenValidator.validateCallValue;
import static org.linda.trident.core.utils.TokenValidator.validateTokenId;
import static org.linda.trident.core.utils.TokenValidator.validateTokenValue;
import static org.linda.trident.core.utils.Utils.encodeParameter;
...
import org.linda.trident.api.GrpcAPI.AccountAddressMessage;
import org.linda.trident.api.GrpcAPI.AccountIdMessage;
import org.linda.trident.api.GrpcAPI.BlockLimit;
import org.linda.trident.api.GrpcAPI.BlockReq;
import org.linda.trident.api.GrpcAPI.BytesMessage;
import org.linda.trident.api.GrpcAPI.CanDelegatedMaxSizeRequestMessage;
import org.linda.trident.api.GrpcAPI.CanDelegatedMaxSizeResponseMessage;
import org.linda.trident.api.GrpcAPI.CanWithdrawUnfreezeAmountRequestMessage;
import org.linda.trident.api.GrpcAPI.CanWithdrawUnfreezeAmountResponseMessage;
import org.linda.trident.api.GrpcAPI.EmptyMessage;
import org.linda.trident.api.GrpcAPI.GetAvailableUnfreezeCountRequestMessage;
import org.linda.trident.api.GrpcAPI.GetAvailableUnfreezeCountResponseMessage;
import org.linda.trident.api.GrpcAPI.NumberMessage;
import org.linda.trident.api.GrpcAPI.PaginatedMessage;
import org.linda.trident.api.GrpcAPI.TransactionIdList;
import org.linda.trident.api.WalletGrpc;
import org.linda.trident.api.WalletSolidityGrpc;
import org.linda.trident.core.contract.Contract;
import org.linda.trident.core.contract.ContractFunction;
...
import org.linda.trident.core.transaction.TransactionCapsule;
import org.linda.trident.core.utils.ByteArray;
import org.linda.trident.core.utils.Sha256Hash;
import org.linda.trident.core.utils.Utils;
import org.linda.trident.proto.Chain.Block;
import org.linda.trident.proto.Chain.Transaction;
import org.linda.trident.proto.Chain.Transaction.Contract.ContractType;
import org.linda.trident.proto.Common.SmartContract;
import org.linda.trident.proto.Contract.AccountCreateContract;
import org.linda.trident.proto.Contract.AccountPermissionUpdateContract;
import org.linda.trident.proto.Contract.AccountUpdateContract;
import org.linda.trident.proto.Contract.AssetIssueContract;
import org.linda.trident.proto.Contract.CancelAllUnfreezeV2Contract;
import org.linda.trident.proto.Contract.ClearABIContract;
import org.linda.trident.proto.Contract.CreateSmartContract;
import org.linda.trident.proto.Contract.DelegateResourceContract;
import org.linda.trident.proto.Contract.ExchangeCreateContract;
import org.linda.trident.proto.Contract.ExchangeInjectContract;
import org.linda.trident.proto.Contract.ExchangeTransactionContract;
import org.linda.trident.proto.Contract.ExchangeWithdrawContract;
import org.linda.trident.proto.Contract.FreezeBalanceContract;
import org.linda.trident.proto.Contract.FreezeBalanceV2Contract;
import org.linda.trident.proto.Contract.MarketCancelOrderContract;
import org.linda.trident.proto.Contract.MarketSellAssetContract;
import org.linda.trident.proto.Contract.ParticipateAssetIssueContract;
import org.linda.trident.proto.Contract.ProposalApproveContract;
import org.linda.trident.proto.Contract.ProposalCreateContract;
import org.linda.trident.proto.Contract.ProposalDeleteContract;
import org.linda.trident.proto.Contract.SetAccountIdContract;
import org.linda.trident.proto.Contract.TransferAssetContract;
import org.linda.trident.proto.Contract.TransferContract;
import org.linda.trident.proto.Contract.TriggerSmartContract;
import org.linda.trident.proto.Contract.UnDelegateResourceContract;
import org.linda.trident.proto.Contract.UnfreezeAssetContract;
import org.linda.trident.proto.Contract.UnfreezeBalanceContract;
import org.linda.trident.proto.Contract.UnfreezeBalanceV2Contract;
import org.linda.trident.proto.Contract.UpdateAssetContract;
import org.linda.trident.proto.Contract.UpdateBrokerageContract;
import org.linda.trident.proto.Contract.UpdateEnergyLimitContract;
import org.linda.trident.proto.Contract.UpdateSettingContract;
import org.linda.trident.proto.Contract.VoteWitnessContract;
import org.linda.trident.proto.Contract.WithdrawBalanceContract;
import org.linda.trident.proto.Contract.WithdrawExpireUnfreezeContract;
import org.linda.trident.proto.Contract.WitnessCreateContract;
import org.linda.trident.proto.Contract.WitnessUpdateContract;
import org.linda.trident.proto.Response;
import org.linda.trident.proto.Response.Account;
import org.linda.trident.proto.Response.AccountNetMessage;
import org.linda.trident.proto.Response.AccountResourceMessage;
import org.linda.trident.proto.Response.AssetIssueList;
import org.linda.trident.proto.Response.BlockBalanceTrace;
import org.linda.trident.proto.Response.BlockExtention;
import org.linda.trident.proto.Response.BlockIdentifier;
import org.linda.trident.proto.Response.BlockListExtention;
import org.linda.trident.proto.Response.ChainParameters;
...
import org.linda.trident.proto.Response.DelegatedResourceMessage;
...
import org.linda.trident.proto.Response.MarketOrderPair;
import org.linda.trident.proto.Response.MarketOrderPairList;
import org.linda.trident.proto.Response.MarketPriceList;
import org.linda.trident.proto.Response.NodeInfo;
import org.linda.trident.proto.Response.NodeList;
import org.linda.trident.proto.Response.PricesResponseMessage;
import org.linda.trident.proto.Response.Proposal;
import org.linda.trident.proto.Response.ProposalList;
import org.linda.trident.proto.Response.SmartContractDataWrapper;
import org.linda.trident.proto.Response.TransactionApprovedList;
...
import org.linda.trident.proto.Response.TransactionReturn;
import org.linda.trident.proto.Response.TransactionSignWeight;
 ...
 *
 * @see org.linda.trident.core.contract.Contract
 * @see org.linda.trident.proto.Chain.Transaction
 * @see org.linda.trident.proto.Contract
...
public class ApiWrapper implements Api {
  ...
  public ApiWrapper(String grpcEndpoint, String grpcEndpointSolidity, String hexPrivateKey,
    ...
    Metadata.Key<String> key = Metadata.Key.of("LINDA-PRO-API-KEY",
  ...
  /**
   * The constructor for main net. Use LindaGrid as default
   *
   ...
   * @param apiKey this function works with LindaGrid, an API key is required.
   * @return a ApiWrapper object
   */
  public static ApiWrapper ofMainnet(String hexPrivateKey, String apiKey) {
    return new ApiWrapper(Constant.LINDAGRID_MAIN_NET, Constant.LINDAGRID_MAIN_NET_SOLIDITY,
   ...
   * This method will only be available before LindaGrid prohibits the use without API key
   */
  @Deprecated
  ...
  /**
   * The constructor for Shasta test net. Use LindaGrid as default.
   *
   * @param hexPrivateKey the binding private key. Operations require private key will all use this unless the private key is specified elsewhere.
   * @return a ApiWrapper object
   */
  public static ApiWrapper ofShasta(String hexPrivateKey) {
    return new ApiWrapper(Constant.LINDAGRID_SHASTA, Constant.LINDAGRID_SHASTA_SOLIDITY,
        hexPrivateKey);
  }
  ...
  private TransactionCapsule createTransactionCapsuleWithoutValidate(
    ...
    TransactionCapsule lind = new TransactionCapsule(message, contractType);

    if (contractType == Transaction.Contract.ContractType.CreateSmartContract) {
      //lind.setTransactionCreate(true);
    ...
    //build transaction
    lind.setTransactionCreate(false);
    //get solid head blockId
    lind.setReference(solidHeadBlockId.getNum(), solidHeadBlockId.getBytes());
    lind.setExpiration(expireTimeStamp);
    lind.setTimestamp();
  ...
  private TransactionExtention createTransactionExtention(Message request,
    ...
    TransactionExtention.Builder lindExtBuilder = TransactionExtention.newBuilder();
    TransactionReturn.Builder retBuilder = TransactionReturn.newBuilder();
    try {
      TransactionCapsule lind = createTransaction(request, contractType);

      if (contractType != Transaction.Contract.ContractType.CreateSmartContract
          && contractType != ContractType.TriggerSmartContract) {
        lindExtBuilder.setTransaction(lind.getTransaction());
      } else {
        if (feeLimit <= 0L) {
          throw new IllegalException("feeLimit must be > 0");
        } else {
          Transaction transaction = lind.getTransaction();
          Transaction newTransaction = transaction.toBuilder()
              .setRawData(transaction.getRawData().toBuilder().setFeeLimit(feeLimit).build())
              .build();
          lindExtBuilder.setTransaction(newTransaction);
        }
      }

      lindExtBuilder.setTxid(ByteString.copyFrom(
          Sha256Hash.hash(true, lindExtBuilder.getTransaction().getRawData().toByteArray())));
    ...
    lindExtBuilder.setResult(retBuilder);
    return lindExtBuilder.build();
  }
  ...
  /**
   * Unfreeze balance to get LIND back
   *
   * @param ownerAddress owner address
   * @param resourceCode Resource type, can be 0("BANDWIDTH") or 1("ENERGY")
   * @return TransactionExtention
   ...
   *
   * @param ownerAddress owner address
   * @param balance Amount of LIND staked for resources to be delegated, unit is sun
   * @param resourceCode Resource type, can be 0("BANDWIDTH") or 1("ENERGY")
   ...
   * @param lindNum Define the price by the ratio of lind_num/num
   * @param icoNum Define the price by the ratio of lind_num/num
  ...
  public TransactionExtention createAssetIssue(String ownerAddress, String name, String abbr,
      long totalSupply, int lindNum, int icoNum, long startTime, long endTime,
    ...
    AssetIssueContract.Builder builder = assetIssueContractBuilder(ownerAddress, name, abbr,
        totalSupply, lindNum, icoNum, startTime, endTime, url, freeAssetNetLimit,
  ...
  public AssetIssueContract.Builder assetIssueContractBuilder(String ownerAddress, String name,
      String abbr, long totalSupply, int lindNum, int icoNum, long startTime, long endTime,
      String url, long freeAssetNetLimit,
   ...
   *
   * @param lind transaction object
   * @return TransactionSignWeight
   */
  @Override
  public TransactionSignWeight getTransactionSignWeight(Transaction lind) {

    return blockingStub.getTransactionSignWeight(lind);
  }
   ...
   */
  @Override
  public TransactionApprovedList getTransactionApprovedList(Transaction lind) {

    return blockingStub.getTransactionApprovedList(lind);
  }
  ...
  public Contract getContract(String contractAddress) {
    ...
    return new Contract.Builder()
        ...
        .setLindHash(smartContract.getLindHash())
   ...
   * @param callValue call Value. If LIND not used, use 0.
  ...
  /**
   * GetBurnLIND
   * Query the amount of LIND burned due to on-chain transaction fees since No. 54 Committee Proposal took effect
   * @param nodeType Optional parameter to specify which node to query.
   *                 If not provided, uses full node default.
   *                 If NodeType.SOLIDITY_NODE, uses solidity node.
   * @return burn lind amount
   */
  @Override
  public long getBurnLIND(NodeType... nodeType) {
    EmptyMessage emptyMessage = EmptyMessage.newBuilder().build();
    NumberMessage numberMessage = useSolidityNode(nodeType)
        ? blockingStubSolidity.getBurnLind(emptyMessage)
        : blockingStub.getBurnLind(emptyMessage);
   ...
   * This API is closed by default in linda node.
  ...
  /**
   * Estimate the energy required for the successful execution of smart contract transactions
   * This API is closed by default in linda node. To open this interface, the two configuration
   ...
   * @param firstToken first token id. LIND is "_", else token10 ID
   * @param firstBalance first token id balance
   * @param secondToken second token id. LIND is "_", else token10 ID
   ...
   * @param ABI abiString
   * @param code bytecode
   * @param callValue the amount of deposit LIND(unit sun), default is 0
