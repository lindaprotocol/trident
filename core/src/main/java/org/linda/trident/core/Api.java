...
public interface Api {
  ...
  TransactionExtention createAssetIssue(String ownerAddress, String name, String abbr,
      long totalSupply, int lindNum, int icoNum, long startTime, long endTime, String url,
  ...
  TransactionSignWeight getTransactionSignWeight(Transaction lind);

  TransactionApprovedList getTransactionApprovedList(Transaction lind);
  ...
  long getBurnLIND(NodeType... nodeType);
